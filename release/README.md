# Release Builds - Meta Automation v1.1.2 (Multi-Platform)

This directory contains official pre-built distribution packages for **Meta Automation v1.1.2** supporting **Linux**, **macOS**, **Windows**, and **Android (Termux + Termux:X11)**.
...
| **`meta-automation-universal-v1.1.2.zip`** | Universal | `.zip` | ~223 KB | All-in-one archive containing all platform scripts & installers. |
| **`meta-automation-1.1.2.tgz`** | Node/npm | `.tgz` | ~1.2 MB | Standard npm distribution package. |
