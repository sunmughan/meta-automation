...
async function runLinkedInCycle(cycle) {
  ...
  try {
    ...
    // 3. Lead qualification & comments on discovered LinkedIn posts
    ...
    // 4. Thought-leadership posting cadence
    if (cycle % 6 === 2 && CONFIG.POSTING_ENABLED && !CONFIG.DRY_RUN) {
